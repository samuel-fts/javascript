...
class Bola{
    ...
    remover=()=>{
        ...
        bolas=bolas.filter((b)=>{// o filter vai percorrer por todo arrey ate encontrar o id igual ao da bolinha selecionada, qunado achar, nao ira retornar ela, somente as que bnao forem iguais
            if(b.id!=this.id){
                return b
            }
        })
    ...
    desenhar=(_=>{
        ...
        this.palco.appendChild(div)//a div sera filha do palco 
    })
}
